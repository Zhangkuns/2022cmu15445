...
void PostgresParser::Parse(const string &query) {
	...
	/**
         * The query.c_str() expression is a call to the c_str() member function of the std::string class in C++.
         * This function is used to get a C-style string (a null-terminated character array) from a C++ std::string object.
         * */
