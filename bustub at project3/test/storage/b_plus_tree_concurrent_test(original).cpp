...
TEST(BPlusTreeConcurrentTest, MixTest5) {
  // create KeyComparator and index schema
  auto key_schema = ParseCreateStatement("a bigint");
  GenericComparator<8> comparator(key_schema.get());
 ...
 */
TEST(BPlusTreeTestC2Con, InsertTest6) {
  TEST_TIMEOUT_BEGIN
  InsertTest1Call();
  remove("test.db");
  remove("test.log");
 ...
 * without overlap.
 */
TEST(BPlusTreeTestC2Con, InsertTest7) {
  TEST_TIMEOUT_BEGIN
  InsertTest2Call();
  remove("test.db");
  remove("test.log");
 ...
 */
TEST(BPlusTreeTestC2Con, DeleteTest8) {
  TEST_TIMEOUT_BEGIN
  DeleteTest1Call();
  remove("test.db");
  remove("test.log");
 ...
 * without overlap.
 */
TEST(BPlusTreeTestC2Con, DeleteTest9) {
  TEST_TIMEOUT_BEGIN
  DeleteTest2Call();
  remove("test.db");
  remove("test.log");
 ...
 */
TEST(BPlusTreeTestC2Con, MixTest10) {
  TEST_TIMEOUT_BEGIN
  MixTest1Call();
  remove("test.db");
  remove("test.log");
 ...
 * inserted.
 */
TEST(BPlusTreeTestC2Con, MixTest11) {
  TEST_TIMEOUT_BEGIN
  MixTest2Call();
  remove("test.db");
  remove("test.log");
 ...
 * deleted and new keys are added correctly.
 */
TEST(BPlusTreeTestC2Con, DISABLED_MixTest12) {
  TEST_TIMEOUT_BEGIN
  MixTest3Call();
  remove("test.db");
  remove("test.log");
...
TEST(BPlusTreeTestC2Con, DISABLED_MixTest13) {
  TEST_TIMEOUT_BEGIN
  MixTest4Call();
  remove("test.db");
  remove("test.log");
 ...
 */
TEST(BPlusTreeConcurrentTestC2Seq, InsertTest14) {
  // create KeyComparator and index schema
  auto key_schema = ParseCreateStatement("a bigint");
  GenericComparator<8> comparator(key_schema.get());
 ...
 * but added iterator for value checking
 */
TEST(BPlusTreeConcurrentTestC2Seq, InsertTest15) {
  // create KeyComparator and index schema
  auto key_schema = ParseCreateStatement("a bigint");
  GenericComparator<8> comparator(key_schema.get());
 ...
 */
TEST(BPlusTreeConcurrentTestC2Seq, DeleteTest16) {
  // create KeyComparator and index schema
 ...
 */
TEST(BPlusTreeConcurrentTestC2Seq, DeleteTest17) {
  // create KeyComparator and index schema
  auto key_schema = ParseCreateStatement("a bigint");
  GenericComparator<8> comparator(key_schema.get());
 ...
 */
TEST(BPlusTreeConcurrentTestC2Seq, ScaleTest18) {
  // create KeyComparator and index schema
  auto key_schema = ParseCreateStatement("a bigint");
  GenericComparator<8> comparator(key_schema.get());
 ...
 * inserted.
 */
TEST(BPlusTreeConcurrentTestC2Seq, SequentialMixTest19) {
  // create KeyComparator and index schema
  auto key_schema = ParseCreateStatement("a bigint");
  GenericComparator<8> comparator(key_schema.get());
