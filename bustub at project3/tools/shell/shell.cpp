...
/* mock table are special tables that do not actually store real tuples.
 * Instead, they are "virtual" tables that use the MockScan executor
 * to always generate the same tuples using a predefined algorithm.*/
